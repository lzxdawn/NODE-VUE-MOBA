  ...
  <div class="hero-page">
    ...
    <div v-if="model" class="top" :style="{'background-image': `url(${model.banner})`}">
      <div class="info text-white p-3 h-100 d-flex flex-column jc-end">
        ...
        <div class="d-flex jc-between pt-2">
          ...
          <router-link tag="div" to="/">皮肤：7 &gt;</router-link>
        </div>
      </div>
    </div>
    <!-- end of top -->
    <div>
      <div class="bg-white px-3">
        <div class="nav d-flex jc-around pt-3 pb-2">
        ...
        <swiper-slide>
          <div>
            <div class="p-3 bg-white border-bottom">
              ...
              <div class="skills bg-white mt-4">
                <div class="d-flex jc-around">
                  ...
                  :src="item.icon" :key="item.name">
                </div>
                <div v-if="currentSkill">
                  <div class="d-flex pt-4 pb-3"> 
                    <h3 class="m-0">{{ currentSkill.name }}</h3>
                    <span class="text-grey-1 ml-4">(冷却值: {{ currentSkill.delay }} 消耗值: {{ currentSkill.cost }})</span>
                  </div>
            ...
            <m-card plain icon="menu1" title="英雄关系">
              ...
              <div class="d-flex mt-4" v-for="item in model.partners">
